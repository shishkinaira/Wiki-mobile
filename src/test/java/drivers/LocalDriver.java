...
public class LocalDriver implements WebDriverProvider {
    ...
    public WebDriver createDriver(@Nonnull Capabilities capabilities) {
        ...
        options.setAutomationName(ANDROID_UIAUTOMATOR2).setPlatformName(config.platformName()).setPlatformVersion(config.getOsVersion()).setDeviceName(config.deviceName()).setApp(getAppPath()).setAppPackage("org.wikipedia.alpha").setAppActivity("org.wikipedia.main.MainActivity");
